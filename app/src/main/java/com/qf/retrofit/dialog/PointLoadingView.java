...
public class PointLoadingView extends View {
    ...
    public PointLoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs,0, R.style.PointLoadingView);
    }

    public PointLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs,defStyleAttr, R.style.PointLoadingView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public PointLoadingView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.PointLoadingView, defStyleAttr, defStyleRes);

        mMinWidth = a.getDimensionPixelSize(R.styleable.PointLoadingView_minWidth, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.PointLoadingView_maxWidth, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(R.styleable.PointLoadingView_minHeight, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.PointLoadingView_maxHeight, mMaxHeight);
        String indicatorName=a.getString(R.styleable.PointLoadingView_indicatorName);
        mIndicatorColor=a.getColor(R.styleable.PointLoadingView_indicatorColor, Color.WHITE);
